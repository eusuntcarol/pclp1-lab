...
⠀⠀⠀⠀⠀⠈⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢸⣧⠀⠀⠀
⠀⠀⠀⠀⠀⠈⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠉⠁⠀⠀⠀"
    echo "Mastering pointers feels like... https://youtu.be/xqds0B_meys?si=nTngzFSS1jOXO9jE"
    exit 0
else
    echo "Almost there! Keep going! ${done_exercises}/${all_exercises} exercises completed. 🏃"
    exit 1
fi
